...
class BarangController extends Controller
{
    ...
    {
        $barang = BarangModel::select('barang_id', 'barang_kode', 'barang_nama', 'harga_beli', 'harga_jual')->orderBy('kategori_id')->with('kategori')->get();
        ...
        foreach ($barang as $key => $value) {
            ...
            $sheet->setCellValue('F' . $baris, $value->kategori->kategori_id); // ambil nama kategori
            $baris++;
            $no++;
        }
